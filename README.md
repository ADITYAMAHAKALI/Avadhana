...
| [`services/`](services/) | Backend API, Moderation, AI Coordinator Worker, a local SARVAM AI mock, and the Web frontend — one Containerfile per service from day one |
...
| [`TODO.md`](TODO.md) | Local mirror of the GitHub issue backlog, grouped by epic — GitHub is the source of truth for status |
